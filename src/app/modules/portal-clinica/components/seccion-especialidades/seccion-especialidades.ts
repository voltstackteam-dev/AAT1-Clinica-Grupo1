...
export class SeccionEspecialidades implements OnInit {
  ...
  private descripciones: Record<string, string> = {
    Cardiología:
      'Prevención, diagnóstico y tratamiento de enfermedades del corazón y sistema circulatorio.',
    Pediatría:
      'Atención médica especializada, controles de crecimiento y desarrollo integral infantil.',
    Traumatología:
      'Cuidado de lesiones óseas y musculares con tratamientos quirúrgicos y de rehabilitación.',
    Neurología:
      'Diagnóstico avanzado y tratamiento de trastornos del cerebro y sistema nervioso central.',
  };
